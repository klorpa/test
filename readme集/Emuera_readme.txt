...
Webページ：http://sourceforge.jp/projects/emuera/
ライセンス：[ライセンス]の項を参照。
...
Microsoftダウンロードセンターから.NET Framework 2.0 ランタイムをダウンロードしてインストールしてください。
...
http://sourceforge.jp/projects/emuera/releases/
...
Copyright (C) 2008-2012 MinorShift, 妊）|дﾟ)の中の人
